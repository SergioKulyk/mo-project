...
-
  ...
  ### Як використовувати
```python
 Team5.faster_gradient_descent(x0, f, gradient, eps=10 ** (-4))
```
#### Вхідні данні:<br> 
**x0** - початкова точка.<br>
**eps** - точність.<br>
**f** - функція<br>
**gradient** - градієнт<br>
#### Вихідні дані:<br>
 **х** - локальний мінімум функції.<br>
...
### Як використовувати
```python
 Team5.mcvard(x0, f, gradient, hesse, eps=10 ** (-20), u=10 ** 2, max_iter=50)
```
#### Вхідні данні:<br> 
***x0*** - початкова точка.<br>
**eps** - точність.<br>
